  ...
  return (
    <main className={`flex min-h-screen justify-center p-8 ${libre_baskerville.className}`}>
      <div className="max-w-lg text-sm">
        ...
        <ul className="flex flex-wrap items-center justify-center text-gray-900 dark:text-white space-x-4">
          <li>
            <a href="mailto:takahiro.swe@example.com" aria-label="at-symbol" data-toggle="tooltip" data-placement="top" title="E-mail Me">
              <svg style={{ height: "1.5rem" }} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className="hover:scale-125">
          ...
          <li>
            <a href="https://twitter.com/dohxjyus" target="_blank" rel="noopener" aria-label="brands/x">
              <svg style={{ height: "1.5rem" }} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" className="hover:scale-125">
          ...
          <li>
            <a href="https://www.instagram.com/" target="_blank" rel="noopener" aria-label="brands/instagram">
              <svg style={{ height: "1.5rem" }} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 15 15" className="hover:scale-125">
          ...
          <li>
            <a href="https://www.linkedin.com/in/takahiro-ishiguro-05573919b/" target="_blank" rel="noopener" aria-label="brands/linkedin">
              <svg style={{ height: "1.5rem" }} xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 448 512" className="hover:scale-125">
