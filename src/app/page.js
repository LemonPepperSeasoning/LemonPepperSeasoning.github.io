    ...
    <RootLayout>
      <main className={`flex min-h-screen justify-center p-8 ${libre_baskerville.className}`}>
        <div className="max-w-lg text-sm">
          ...
          <ul className="flex flex-wrap items-center justify-center text-gray-900 dark:text-white space-x-4 mb-10">
            <li>
              <a href="mailto:takahiro.swe@example.com" target="_blank" rel="noopener" aria-label="brands/github">
